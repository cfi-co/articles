...
> Verbatim archived copy. Canonical machine record: `13139-didier-drogba-just-do-it.json`.

<p style="text-align: justify;"><img class="alignright size-medium wp-image-13140" src="https://cfi.co/wp-content/uploads/2018/11/Didier-Drogba-300x200.jpg" alt="" width="300" height="200" />At a time when transfer sums seldom exceeded seven digits, Didier Drogba’s £24m move to Chelsea in 2004 both broke the record and caused a global buzz.</p>
...
<p style="text-align: justify;">In a soccer match, too much interplay often wrongfoots an attack. In the same way, the solution to many of the world’s problems is most likely to be found along a straight line that points at the desired outcome. Just Do It.</p>
