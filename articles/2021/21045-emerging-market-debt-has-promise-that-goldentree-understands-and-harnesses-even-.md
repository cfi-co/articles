...
> Verbatim archived copy. Canonical machine record: `21045-emerging-market-debt-has-promise-that-goldentree-understands-and-harnesses-even-.json`.

<p style="text-align: justify;"><strong>Macro-economic crosscurrents have led to a broad opportunity set in credit markets, and global credit manager GoldenTree has delivered compelling returns to investors despite the turbulent times.</strong></p>
...
<p style="text-align: justify;">The firm’s investment team, its process, and the flexible nature of its strategy, enable GoldenTree to identify investments with the most attractive risk-return profiles across market environments.</p>
