...
> Verbatim archived copy. Canonical machine record: `20738-energean-ep-company-with-a-clear-conscience-committed-to-carbon-emissions-cuts.json`.

<p style="text-align: justify;"><strong>Energean is a gas-focused independent exploration and production (E&amp;P) company — the first in the world to commit to a 2050 zero emissions target and is now looking to significantly accelerate that.</strong></p>
...
<p style="text-align: justify;">Energean links executive incentive pay with performance on ESG targets, commits to transparent disclosure of emissions tracking, and engages with all stakeholders to precipitate the transition to a low-carbon future.</p>
