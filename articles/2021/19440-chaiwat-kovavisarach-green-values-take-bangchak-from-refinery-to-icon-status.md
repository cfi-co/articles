...
> Verbatim archived copy. Canonical machine record: `19440-chaiwat-kovavisarach-green-values-take-bangchak-from-refinery-to-icon-status.json`.
...
<p style="text-align: justify;">His passion for green innovation – above and beyond Bangchak’s businesses – is reflected in a monthly column in <em>Krungthep Thurakij </em>(<em>Bangkok BizNews</em>). Two compilations of his articles have been published in book form.</p>
