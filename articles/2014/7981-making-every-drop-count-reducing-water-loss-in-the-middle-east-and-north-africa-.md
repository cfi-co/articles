...
> Verbatim archived copy. Canonical machine record: `7981-making-every-drop-count-reducing-water-loss-in-the-middle-east-and-north-africa-.json`.
...
<p style="text-align: justify;">Other participants, such as Morocco’s ONEE, Northern Lebanon’s water establishment, and utilities from Sana’a and Aden, also expressed their interest in exchanges with the WSC. Based on this, a comprehensive twinning program between the WSC and MENA utilities will be finalized in the next few months, so as to start exchanges in the field before the end of 2014.</p>
