...
> Verbatim archived copy. Canonical machine record: `22433-imf-turbulence-and-the-lessons-of-history.json`.

<p class="intro-text">Opportunities are born of crisis, but the lines that connect them are far from direct</p>
