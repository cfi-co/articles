...
> Verbatim archived copy. Canonical machine record: `23130-the-access-bank-uk-limited-a-bank-whose-guiding-principles-focus-on-customer-ser.json`.

<p style="text-align: justify;"><em>A moderate appetite for risk and a passion for serving its customers is standing The Access Bank UK Ltd in good stead.</em></p>
...
<p style="text-align: justify;">“When I established the The Access Bank UK Ltd in January 2008, it was at a turbulent time in banking — but we set the risk appetite, the processes and procedures, and developed products that our customers wanted.”</p>
