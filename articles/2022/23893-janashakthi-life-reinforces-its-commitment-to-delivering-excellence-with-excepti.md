...
> Verbatim archived copy. Canonical machine record: `23893-janashakthi-life-reinforces-its-commitment-to-delivering-excellence-with-excepti.json`.

<p style="text-align: justify;"><em>Sri Lanka’s <span style="text-decoration: underline;">Janashakthi Life</span> puts its staff and customers front and centre to ensure exceptional performance. </em></p>
...
<p style="text-align: justify;">Sri Lanka is by its nature a resilient country. Political and economic stability benefit from reforms. Changing the economic model towards that of a self-sufficient nation is possible in essential goods and services.</p>
