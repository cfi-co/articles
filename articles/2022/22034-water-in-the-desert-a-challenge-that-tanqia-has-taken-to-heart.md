...
> Verbatim archived copy. Canonical machine record: `22034-water-in-the-desert-a-challenge-that-tanqia-has-taken-to-heart.json`.

<p style="text-align: justify;"><strong>TANQIA, the UAE’s first privately owned wastewater collection and treatment utility, does not lack vision.</strong></p>
...
<p style="text-align: justify;">TANQIA has been working on a solution that reduces the cost of polishing effluent, and the cost of treatment. This will require more data collection, examining the quality of output and energy use per gallon of water, to determine the commercial potential.</p>
