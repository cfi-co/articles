...
> Verbatim archived copy. Canonical machine record: `22051-infinity-asset-management-diversity-and-strategy-two-key-factors-that-have-drive.json`.

<p style="text-align: justify;"><strong>It was 25 years ago, in São Paulo, Brazil, that Infinity Asset Management, and the Infinity Group, started as a brokerage firm.</strong></p>
...
<p style="text-align: justify;">Despite recent market instability, Infinity’s results speak for themselves: a two-year return from three of its fixed-income funds. “We enable the achievement and refinement of the financial life goals our clients,” says Fernandez.</p>
