...
> Verbatim archived copy. Canonical machine record: `26136-when-wheels-fall-off-a-gender-balance-bid-by-a-wall-st-hedge-fund-it-turns-to-wo.json`.

<p style="text-align: justify;"><em>Fair Play, screening on streaming service Netflix, shows that entrenched, society-imposed values can be hard for individuals to shake off...</em></p>
...
<p style="text-align: justify;"><em>By Hal Williams</em></p>
