...
> Verbatim archived copy. Canonical machine record: `16088-banco-economico-angola-on-the-brink-of-a-new-era.json`.

<p style="text-align: justify;"><strong>Angola is a country with huge economic potential that is facing an encouraging political environment for foreign investment.</strong></p>
...
<p style="text-align: justify;">Angola is entering a new era and we will have the opportunity to target lower and emerging market sectors. We will push our operation and business results forward. These are the main changes in terms of how Banco Económico will approach the market, and the future.</p>
