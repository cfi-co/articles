...
> Verbatim archived copy. Canonical machine record: `5323-global-interconnections-and-spillovers.json`.

<p style="text-align: justify;"><em><strong>Extracts from a Speech By Christine Lagarde, Managing Director, International Monetary Fund</strong></em></p>
...
<p style="text-align: justify;">In this context, the IMF is currently working toward a set of governance reforms that will strengthen further our capacity to prevent and resolve crises; and at the same time, will help broaden our representation to better reflect the changing dynamics of the global economy. These “quota” reforms need the support of all our member countries—including the United States.</p>
