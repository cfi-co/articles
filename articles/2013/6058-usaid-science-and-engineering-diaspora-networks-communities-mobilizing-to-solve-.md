...
> Verbatim archived copy. Canonical machine record: `6058-usaid-science-and-engineering-diaspora-networks-communities-mobilizing-to-solve-.json`.
...
<p style="text-align: justify;">Questions and inquiries about how to partner with USAID can be directed to: <a href="mailto:robhatia@usaid.gov" target="_blank" rel="noopener noreferrer">robhatia@usaid.gov</a></p>
